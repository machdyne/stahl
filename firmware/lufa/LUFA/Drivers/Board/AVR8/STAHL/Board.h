...
/** \file
 *  \brief Board specific information header for the Atmel STAHL.
 *  \copydetails Group_BoardInfo_STAHL
 *
 ...
 *  \defgroup Group_BoardInfo_STAHL STAHL
 *  \brief Board specific information header for the Atmel STAHL.
 *
 *  Board specific information header for the Atmel STAHL.
 *
 *  @{
 */

#ifndef __BOARD_STAHL_H__
#define __BOARD_STAHL_H__
